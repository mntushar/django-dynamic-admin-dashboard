            ...
            return (
                ...
                babelHelpers.createClass(Site, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var breakpoint = this.getCurrentBreakpoint(),
                                type = !1;
                            switch (
                                ((!1 === $BODY.data("autoMenubar") || $BODY.is(".site-menubar-keep")) && ($BODY.hasClass("site-menubar-fold") ? (type = "fold") : $BODY.hasClass("site-menubar-unfold") && (type = "unfold")), breakpoint)
                            ) {
                                case "lg":
                                    type = type || "unfold";
                                    break;
                    ...
                    },
                    {
                        key: "getDefaultState",
                        value: function () {
                            return { menubarType: this._getDefaultMeunbarType(), gridmenu: !1 };
                        },
                    },
                    {
                        key: "menubarType",
